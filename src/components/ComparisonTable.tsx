            ...
            <thead className="bg-gray-900 text-white">
              <tr>
                ...
                {products.map((product, index) => (
                  <th key={index} className="text-center p-6 pt-8 relative">
                    {product.popular && (
                      <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 bg-yellow-500 text-black px-3 py-1 rounded-full text-xs font-bold">
                        MOST POPULAR
                      </div>
                    )}
