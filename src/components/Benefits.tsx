...
const Benefits = () => {
  ...
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-yellow-50 to-gray-100">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {benefits.map((benefit, index) => (
            <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <div className="text-yellow-600 font-bold text-sm">{benefit.stat}</div>
            </div>
          ))}
        </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-yellow-500 pl-4">
                  <h4 className="font-semibold text-gray-900">Automotive Manufacturing Plant</h4>
                  <p className="text-gray-600">Reduced assembly line noise by 14dB, improving worker communication and reducing fatigue complaints by 40%.</p>
                </div>
                <div className="border-l-4 border-yellow-600 pl-4">
                  <h4 className="font-semibold text-gray-900">Distribution Warehouse</h4>
                  <p className="text-gray-600">Created quiet zones for office staff while maintaining operational flexibility for equipment movement.</p>
                </div>
                <div className="border-l-4 border-red-800 pl-4">
                  <h4 className="font-semibold text-gray-900">Food Processing Facility</h4>
                  <p className="text-gray-600">Met OSHA compliance requirements while maintaining easy cleaning protocols in sanitary environment.</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-xl p-6 text-white text-center">
