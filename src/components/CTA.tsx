...
const CTA = () => {
  return (
    <section className="py-16 px-4 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white">
      <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-300">Our acoustic specialists assess your noise levels and requirements</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-blue-600 w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-slate-300">We create a tailored solution that fits your space and budget</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="bg-blue-600 w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div>
                  ...
                  <p className="text-slate-300">Expert installation ensures optimal performance and longevity</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 bg-white/10 rounded-lg p-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-300">(555) 123-NOISE</div>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white/10 rounded-lg p-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-300">quotes@industrial-sound.com</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 grid md:grid-cols-4 gap-6 text-center">
          <div className="bg-white/10 rounded-xl p-6">
            ...
            <p className="text-sm text-slate-300">Custom pricing for your project</p>
          </div>
          <div className="bg-white/10 rounded-xl p-6">
            <FileText className="w-8 h-8 text-blue-400 mx-auto mb-3" />
            <h4 className="font-semibold mb-2">Technical Specs</h4>
            <p className="text-sm text-slate-300">Detailed product documentation</p>
          </div>
          <div className="bg-white/10 rounded-xl p-6">
            <Phone className="w-8 h-8 text-blue-400 mx-auto mb-3" />
            <h4 className="font-semibold mb-2">Expert Support</h4>
            <p className="text-sm text-slate-300">Acoustic engineering guidance</p>
          </div>
          <div className="bg-white/10 rounded-xl p-6">
            <Mail className="w-8 h-8 text-blue-400 mx-auto mb-3" />
            <h4 className="font-semibold mb-2">24hr Response</h4>
            <p className="text-sm text-slate-300">Quick turnaround on quotes</p>
          </div>
        </div>
      </div>
    </section>
